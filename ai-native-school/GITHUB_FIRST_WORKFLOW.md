...
## 2. Delivery Flow (Sarah & Aether Role Split)
- **Sarah (Lead)**: 
...
- **Aether (Assist)**: 
  - Conducts "Content Accuracy Audits" (Epic I-2).
  - Assists in automated grading via the "Homework Reviewer" skill.
...
3. **Grading**: Sarah/Aether trigger the "Homework Reviewer" skill to post feedback against the lesson's `rubrics.md`.
